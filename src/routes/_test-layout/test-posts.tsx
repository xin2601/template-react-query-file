...
export const Route = createFileRoute('/_test-layout/test-posts')({
    component: TestPosts,
})
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="flex flex-wrap gap-4">
                            ...
                            >
                                {createPostMutation.isPending ? '创建中...' : '创建测试文章'}
                            </Button>
                ...
                <Card>
                    ...
                    <CardContent>
                        {isLoading ? (
                            ...
                            <div className="text-center py-8">
                                <p className="text-gray-500 mb-4">暂无测试文章</p>
